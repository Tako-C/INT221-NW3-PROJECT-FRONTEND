describe(`TC-PBI2-VIEW-TASK-TABLE-VIEW-4\n 
  ...
  it('Open task detail for "_Infrastructure_"',()=>{
    ...
    cy.get('.itbkk-created-on').contains('26/04/2024')
    cy.get('.itbkk-created-on').contains('14:56:47')
    cy.get('.itbkk-updated-on').contains('26/04/2024')
    cy.get('.itbkk-updated-on').contains('15:40:56')
  })
